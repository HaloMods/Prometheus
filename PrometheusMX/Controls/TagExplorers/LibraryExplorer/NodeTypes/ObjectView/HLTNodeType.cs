...
{
  public class HLTNodeType : NodeType
  {
    public HLTNodeType() : base("hlt", 2, 1, false) { ; }
    ...
    public override NodeInfo GetParentNodeInfo(NodeInfo info)
    {
      ...
      NodeInfo parentInfo = new NodeInfo(ParentSource.GetNodeType<HLTGroupNodeType>(), groupName);
      return parentInfo;
    }
