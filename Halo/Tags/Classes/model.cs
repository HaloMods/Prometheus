...
namespace Games.Halo.Tags.Classes {
  ...
  public partial class model : Interfaces.Pool.Tag {
    private ModelBlock modelValues = new ModelBlock();
    public virtual ModelBlock ModelValues {
      get {
        return modelValues;
      }
    }
...
modelValues.WriteChildData(writer);
    ...
    public class ModelBlock : IBlock {
      ...
      public BlockCollection<ModelRegionBlock> _regionsList = new BlockCollection<ModelRegionBlock>();
      public BlockCollection<ModelGeometryBlock> _geometriesList = new BlockCollection<ModelGeometryBlock>();
...
public event System.EventHandler BlockNameChanged;
      ...
      public BlockCollection<ModelRegionBlock> Regions {
        get {
          return this._regionsList;
        }
      }
      public BlockCollection<ModelGeometryBlock> Geometries {
        get {
...
return "";
      ...
      public virtual void ReadChildData(BinaryReader reader) {
        ...
        for (x = 0; (x < _regions.Count); x = (x + 1)) {
          Regions.Add(new ModelRegionBlock());
        ...
        for (x = 0; (x < _geometries.Count); x = (x + 1)) {
          Geometries.Add(new ModelGeometryBlock());
...
return _name.ToString();
    ...
    public class ModelRegionBlock : IBlock {
      ...
      public BlockCollection<ModelRegionPermutationBlock> _permutationsList = new BlockCollection<ModelRegionPermutationBlock>();
public event System.EventHandler BlockNameChanged;
...
if (this._name is System.ComponentModel.INotifyPropertyChanged)
  ...
  { if (BlockNameChanged != null) BlockNameChanged(this, new System.EventArgs()); };
      ...
      public BlockCollection<ModelRegionPermutationBlock> Permutations {
        get {
...
return _name.ToString();
      ...
      public virtual void ReadChildData(BinaryReader reader) {
        ...
        for (x = 0; (x < _permutations.Count); x = (x + 1)) {
          Permutations.Add(new ModelRegionPermutationBlock());
...
return _name.ToString();
    ...
    public class ModelGeometryBlock : IBlock {
      ...
      public BlockCollection<ModelGeometryPartBlock> _partsList = new BlockCollection<ModelGeometryPartBlock>();
public event System.EventHandler BlockNameChanged;
      public ModelGeometryBlock() {
        this._flags = new Flags(4);
        this._unnamed = new Pad(32);
      }
      public BlockCollection<ModelGeometryPartBlock> Parts {
        get {
...
return "";
      ...
      public virtual void ReadChildData(BinaryReader reader) {
        ...
        for (x = 0; (x < _parts.Count); x = (x + 1)) {
          Parts.Add(new ModelGeometryPartBlock());
          Parts[x].Read(reader);
        }
        for (x = 0; (x < _parts.Count); x = (x + 1)) {
