...
// Tag definition for 'shader_transparent_chicago' (derived from 'shader')
...
namespace Games.Halo.Tags.Classes {
  ...
  public partial class shader_transparent_chicago : shader {
    private ShaderTransparentChicagoBlock shaderTransparentChicagoValues = new ShaderTransparentChicagoBlock();
    public virtual ShaderTransparentChicagoBlock ShaderTransparentChicagoValues {
      get {
        return shaderTransparentChicagoValues;
      }
    }
...
references.AddRange(ShaderTransparentChicagoValues.TagReferenceList);
...
shaderTransparentChicagoValues.WriteChildData(writer);
    ...
    public class ShaderTransparentChicagoBlock : IBlock {
      ...
      public BlockCollection<ShaderTransparentChicagoMapBlock> _mapsList = new BlockCollection<ShaderTransparentChicagoMapBlock>();
public event System.EventHandler BlockNameChanged;
      ...
      public BlockCollection<ShaderTransparentChicagoMapBlock> Maps {
        get {
...
return "";
      ...
      public virtual void ReadChildData(BinaryReader reader) {
        ...
        for (x = 0; (x < _maps.Count); x = (x + 1)) {
          Maps.Add(new ShaderTransparentChicagoMapBlock());
          Maps[x].Read(reader);
        }
        for (x = 0; (x < _maps.Count); x = (x + 1)) {
