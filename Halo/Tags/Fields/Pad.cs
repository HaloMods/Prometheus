...
namespace Games.Halo.Tags.Fields
{
  public class Pad : IField
  {
    ...
    {
      string pos = null; ;
      if (TagDebug.EnableReadDebug) pos = string.Format("    {0:X} ({1:X}):  ", (int)reader.BaseStream.Position + 0x40, (int)reader.BaseStream.Position);
    ...
    public override string ToString()
    {
      ...
      sb.Append(string.Format("Pad: Length = 0x{0:X}\r\n", length));
      while (c < length)
      {
