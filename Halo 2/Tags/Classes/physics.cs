...
namespace Games.Halo2.Tags.Classes {
  ...
  public partial class physics : Interfaces.Pool.Tag {
    private PhysicsBlockBlock physicsValues = new PhysicsBlockBlock();
    public virtual PhysicsBlockBlock PhysicsValues {
      get {
...
physicsValues.WriteChildData(writer);
    ...
    #endregion
    public class PhysicsBlockBlock : IBlock {
      ...
      public BlockCollection<InertialMatrixBlockBlock> _inertialMatrixAndInverseList = new BlockCollection<InertialMatrixBlockBlock>();
      public BlockCollection<PoweredMassPointBlockBlock> _poweredMassPointsList = new BlockCollection<PoweredMassPointBlockBlock>();
      public BlockCollection<MassPointBlockBlock> _massPointsList = new BlockCollection<MassPointBlockBlock>();
public event System.EventHandler BlockNameChanged;
      public PhysicsBlockBlock() {
        this._unnamed0 = new Pad(4);
        this._unnamed1 = new Pad(4);
        this._unnamed2 = new Pad(4);
      }
      public BlockCollection<InertialMatrixBlockBlock> InertialMatrixAndInverse {
        get {
          return this._inertialMatrixAndInverseList;
        }
      }
      public BlockCollection<PoweredMassPointBlockBlock> PoweredMassPoints {
        get {
          return this._poweredMassPointsList;
        }
      }
      public BlockCollection<MassPointBlockBlock> MassPoints {
        get {
...
_massPoints.Count = MassPoints.Count;
    ...
    public class InertialMatrixBlockBlock : IBlock {
      private RealVector3D _yy_Pluszz_Minusxy_Minuszx = new RealVector3D();
      private RealVector3D @__MinusxyZz_Plusxx_Minusyz = new RealVector3D();
      private RealVector3D @__Minuszx_MinusyzXx_Plusyy = new RealVector3D();
public event System.EventHandler BlockNameChanged;
      public InertialMatrixBlockBlock() {
      }
      public virtual string[] TagReferenceList {
        get {
UniqueStringCollection references = new UniqueStringCollection();
...
return "";
      ...
      public RealVector3D Yy_Pluszz_Minusxy_Minuszx {
        get {
          return this._yy_Pluszz_Minusxy_Minuszx;
        }
        set {
          this._yy_Pluszz_Minusxy_Minuszx = value;
        }
      }
      public RealVector3D _MinusxyZz_Plusxx_Minusyz {
        get {
          return this.@__MinusxyZz_Plusxx_Minusyz;
        }
        set {
          this.@__MinusxyZz_Plusxx_Minusyz = value;
        }
      }
      public RealVector3D _Minuszx_MinusyzXx_Plusyy {
        get {
          return this.@__Minuszx_MinusyzXx_Plusyy;
        }
        set {
          this.@__Minuszx_MinusyzXx_Plusyy = value;
        }
      }
      public virtual void Read(BinaryReader reader) {
        _yy_Pluszz_Minusxy_Minuszx.Read(reader);
        @__MinusxyZz_Plusxx_Minusyz.Read(reader);
        @__Minuszx_MinusyzXx_Plusyy.Read(reader);
      }
      public virtual void ReadChildData(BinaryReader reader) {
      }
      public virtual void Write(BinaryWriter bw) {
        _yy_Pluszz_Minusxy_Minuszx.Write(bw);
        @__MinusxyZz_Plusxx_Minusyz.Write(bw);
        @__Minuszx_MinusyzXx_Plusyy.Write(bw);
      }
      public virtual void WriteChildData(BinaryWriter writer) {
      }
    }
    public class PoweredMassPointBlockBlock : IBlock {
      ...
      private Pad _unnamed0;
public event System.EventHandler BlockNameChanged;
      public PoweredMassPointBlockBlock() {
...
return _name.ToString();
    ...
    public class MassPointBlockBlock : IBlock {
      private FixedLengthString _name = new FixedLengthString();
